...
class TestRegistrationForm:
    ...
    def test_first_name(self, page, caplog, logger):
    ...
    def test_last_name(self, page, caplog, logger):
    ...
    def test_email(self, page, caplog, logger):
    ...
    def test_gender(self, page, gender, caplog, logger):
    ...
    def test_mobile(self, page, caplog, logger):
    ...
    def test_hobbies(self, page, hobbies, caplog, logger):
    ...
    def test_upload_picture(self, page, caplog, logger):
    ...
    def test_date_of_birth(self, page, caplog, logger):
    ...
    def test_subjects(self, page, subjects, caplog, logger):
    ...
    def test_current_address(self, page, caplog, logger):
    ...
    def test_state_city(self, page, state, city, browser, caplog, logger):
